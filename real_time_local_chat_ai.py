...
if __name__ == "__main__":
    ...
    vad_detector = VADDetector2(source_dir+"vad_model/files/silero_vad.onnx")
    ...
    stt_dir1 =source_dir+ 'sst_model/sst_model'
    processor_stt = WhisperProcessor.from_pretrained(stt_dir1, local_files_only = True)
    model_stt = WhisperForConditionalGeneration.from_pretrained(stt_dir1, local_files_only = True)

    #
    # load bell audio files
    #
    audio_data, sample_width, channels, sample_rate = load_audio('AI_assistance/audio_files/bell_short_wav2.wav')
    audio_data2, sample_width2, channels2, sample_rate2 = load_audio('AI_assistance/audio_files/bell2_short_wav2.wav')
